 ...
 * INTRODUCE：$
 */
public class MoreHotAdapter extends RecyclerView.Adapter {

    private Context context;

    public MoreHotAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        HotMovieBean.ResultBean bean = list.get(position);
    ...
    private IMoreHotCallBack callBack;

    public void setCallBack(IMoreHotCallBack callBack) {
        this.callBack = callBack;
    }

    public interface IMoreHotCallBack{
