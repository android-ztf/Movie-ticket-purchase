...
public class UserCinemaCommentFragment_ViewBinding implements Unbinder {
  private UserCinemaCommentFragment target;

  @UiThread
  public UserCinemaCommentFragment_ViewBinding(UserCinemaCommentFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UserCinemaCommentFragment target = this.target;
