...
public class UserMovieCommentFragment_ViewBinding implements Unbinder {
  private UserMovieCommentFragment target;

  @UiThread
  public UserMovieCommentFragment_ViewBinding(UserMovieCommentFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UserMovieCommentFragment target = this.target;
