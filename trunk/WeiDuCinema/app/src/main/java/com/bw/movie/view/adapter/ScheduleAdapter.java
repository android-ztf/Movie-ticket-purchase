...
public class ScheduleAdapter extends RecyclerView.Adapter {
    ...
    private List<CinemaMovieListBean.ResultBean> list;

    public void setList(List<CinemaMovieListBean.ResultBean> list) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        CinemaMovieListBean.ResultBean bean = list.get(position);
        ...
        viewHolder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (callBack!=null)
                    callBack.onClick(bean.getMovieId());
            }
        });
    ...
    private OnMovieListCallBack callBack;

    public void setCallBack(OnMovieListCallBack callBack) {
